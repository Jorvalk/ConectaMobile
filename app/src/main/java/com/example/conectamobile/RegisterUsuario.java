        ...
        BotonRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (correo.isEmpty() || contrasenia.isEmpty() || confirmarContrasenia.isEmpty()) {
                    Toast.makeText(RegisterUsuario.this, "Completa todos los campos", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (contrasenia.length() < 8) {
                    Toast.makeText(RegisterUsuario.this, "La contraseña debe tener al menos 8 caracteres", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (!contrasenia.equals(confirmarContrasenia)) {
                    Toast.makeText(RegisterUsuario.this, "Las contraseñas no coinciden", Toast.LENGTH_SHORT).show();
                    return;
                }

                auth.createUserWithEmailAndPassword(correo, contrasenia)
                        .addOnCompleteListener(RegisterUsuario.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(RegisterUsuario.this, "Error al registrar el usuario", Toast.LENGTH_SHORT).show();
